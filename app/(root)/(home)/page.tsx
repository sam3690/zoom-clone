...
const Home = () => {
const now = new Date()  ;
  const time = now.toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true })   //for Time format
  const date = (new Intl.DateTimeFormat('en-US', { dateStyle: 'full' }).format(now))   //for date format
